import { LockKeyhole, MailCheckIcon, UserRound } from 'lucide-react';
                ...
                <div className="relative">
                    ...
                    <div className="relative">
                        <input
                            ...
                            required
                        />
                        <MailCheckIcon size={24} className="absolute left-3 top-1/2 transform -translate-y-1/2 rounded-full" /> {/* Adjust icon size and position */}
                    </div>
                    <div className="relative">
                        <input
                            type="password"
